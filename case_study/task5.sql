select all kh.id, kh.ho_ten, lk.ten_loai_khach, hd.id, dv.ten_dich_vu, hd.ngay_lam_hop_dong,
 hd.ngay_ket_thuc, dv.chi_phi_thue + (dvdk.gia * dvdk.don_vi) as 'Tổng tiền'
from khach_hang kh
